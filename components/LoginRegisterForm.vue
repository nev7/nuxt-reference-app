    ...
    <v-flex xs6>
      ...
      <v-form>
        ...
        <v-text-field
          ...
          type="text"
          name="email"
          placeholder="e.g jane.doe@xxxxx.com"
        ...
        <v-text-field
          ...
          label="Password"
          name="password"
          :append-icon="showPwdIcon ? 'visibility_off' : 'visibility'"
          :error-messages="errors.collect('password')"
          v-validate="'required|max:15|min:8'"
          :type="showPwdIcon ? 'text' : 'password'"
          @click:append="showPwdIcon = !showPwdIcon"
        ></v-text-field>
        <FormButton
          :clickFunc="login"
          :btnVisible="showBtnOne"
          :btnText="buttonText"
          :btnName="buttonName"
        ...
        <FormButton
          :clickFunc="register"
          :btnVisible="showBtnTwo"
          :btnText="buttonTextTwo"
          :btnName="buttonNameTwo"
          :btnDisabled="isLoading"
        />
        <nuxt-link
          class="register-link"
      ...
      try {
        ...
        if (validationResponse) {
          ...
          if (checkUser.data.length < 1) {
            ...
            this.clearForm()
            this.alertText =
              'User already exsists please use different credentials.'
            this.alertColor = 'error'
            this.alertIcon = 'error'
            this.alertVisible = true
          }
